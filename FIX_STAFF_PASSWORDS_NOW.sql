-- ============================================================================
-- FIX STAFF PASSWORDS - RUN THIS NOW!
-- ============================================================================
-- This will update all staff passwords to use "staff123"
...
SELECT 
    ...
    CASE 
        WHEN sa.hashed_password = '$2a$10$WJJBhmpdwdyvNBoSSzX6Ie1srcJOtCFONDLxW4gyOhBntbhDjpJPq' 
        THEN '✓ CORRECT' 
        ELSE '✗ WRONG' 
    END as status
FROM staff s
