@echo off
REM ============================================================================
REM Script: run_test_release_expired_holds.bat
REM Description: Test release_expired_holds function
...
REM Run tests
psql -h %DB_HOST% -p %DB_PORT% -U %DB_USER% -d %DB_NAME% -f test_release_expired_holds_function.sql
